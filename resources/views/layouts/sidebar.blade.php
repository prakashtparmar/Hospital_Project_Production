<div id="sidebar" class="sidebar responsive ace-save-state">
    ...
    <ul class="nav nav-list">
        ...
        <li class="{{ request()->is('doctors*','patients*','opd*','ipd*','appointments*','consultations*','doctor-schedule*') ? 'open' : '' }}">
            <a href="#" class="dropdown-toggle">
        ...
        {{-- PHARMACY --}}
        @canany([
            'medicine-categories.view','medicine-units.view','medicines.view',
            'suppliers.view','purchases.view','issue-medicines.view','stock-adjustments.view'
        ])
        <li class="{{ request()->is(
            'medicine-categories*','medicine-units*','medicines*','suppliers*',
            'purchases*','issue-medicines*','stock-adjustments*'
        ) ? 'open' : '' }}">
            <a href="#" class="dropdown-toggle">
