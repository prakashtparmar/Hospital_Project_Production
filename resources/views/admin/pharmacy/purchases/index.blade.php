                                        ...
                                        <td>
                                            ...
                                            @can('purchases.view')
                                                <a href="{{ route('purchases.show', $p->id) }}"
                                                    class="btn btn-xs btn-primary" title="Show Purchase">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                <a href="{{ route('purchases.invoice', $p->id) }}"
                                                    class="btn btn-xs btn-warning" title="Print / View Invoice">
                                                    <i class="fa fa-print"></i>
                                                </a>

                                                <a href="{{ route('purchases.invoice.pdf', $p->id) }}"
                                            ...
                                            @can('purchases.edit')
                                                @if ($p->status != 'completed')
                                                    <a href="{{ route('purchases.edit', $p->id) }}"
                                                        class="btn btn-xs btn-info" title="Edit Purchase">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                @else
                                                    <button class="btn btn-xs btn-default" disabled
                                                        title="Cannot edit completed purchase">
                                                ...
                                                <tbody>
                                                    @foreach ($p->items as $i)
                                                        <tr>
                                                            ...
                                                            <td>₹{{ number_format($i->discount_amount, 2) }}</td>
                                                            <td>{{ $i->tax_percent }}%</td>
                                                            <td>₹{{ number_format($i->tax_amount, 2) }}</td>
                                                            <td><strong>₹{{ number_format($i->total_amount, 2) }}</strong></td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
