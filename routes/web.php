...
// Purchase Invoice Preview (HTML)
    ...
    Route::get(
        ...
        [LabTestParameterController::class, 'index']
    )->name('lab.parameters.index');
    ...
    Route::get(
        'lab-tests/{lab_test:id}/parameters/{parameter:id}/edit',
        [LabTestParameterController::class, 'edit']
    )->name('lab.parameters.edit');

    Route::put(
        'lab-tests/{lab_test:id}/parameters/{parameter:id}',
        [LabTestParameterController::class, 'update']
    )->name('lab.parameters.update');

    Route::delete(
        'lab-tests/{lab_test:id}/parameters/{parameter:id}',
        [LabTestParameterController::class, 'destroy']
    )->name('lab.parameters.destroy');
